...
public class MainActivity extends AppCompatActivity {
    ...
    void shareText(String textToShow){
        String mimeType = "text/plain";
        String title = "Hello World";
        ShareCompat.IntentBuilder.from(this).setType(mimeType).setChooserTitle(title).setText(textToShow).startChooser();
    }
